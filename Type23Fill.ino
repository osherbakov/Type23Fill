...
{
  0x00, 0x01,       // Single Channel Cell
  0xFF,             // All channels are valid
  0x0B, 0x01, 0x99, // CUE = 0x0B0, MAN = 0x199
  0x32, 0x04, 0xB0, // CH1 = 0x320, CH2 = 0x4B0
  0x64, 0x07, 0xD0, // CH3 = 0x640, CH4 = 0x7D0
  0x96, 0x0A, 0xF0, // CH5 = 0x960, CH6 = 0xAF0
  0x00  // CRC
};
